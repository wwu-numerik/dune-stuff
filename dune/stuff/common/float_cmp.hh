...
template< class T, template <class> class FirstVectorType,
          template <class> class SecondVectorType = FirstVectorType,
          Dune::FloatCmp::CmpStyle style = Dune::FloatCmp::defaultCmpStyle >
bool ne(const FirstVectorType< T >& first,
        const SecondVectorType< T >& second,
        typename Dune::FloatCmp::EpsilonType< T >::Type epsilon = Dune::FloatCmp::DefaultEpsilon< T, style >::value())
{
...
bool eq(const Dune::DynamicVector< T >& first,
...
bool eq(const Dune::FieldVector< T, size >& first,
...
#if HAVE_EIGEN
template< class T, Dune::FloatCmp::CmpStyle style = Dune::FloatCmp::defaultCmpStyle >
bool eq(const Dune::Stuff::LA::EigenDenseVector< T >& first,
