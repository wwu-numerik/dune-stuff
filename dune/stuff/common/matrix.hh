...
//! TODO
template< class MatrixImp >
struct DUNE_DEPRECATED_MSG("deprecated dune-fem util, use stuff/la instead")
  PrecondionWrapperDummy
{
...
FieldMatrixImp rowWiseMatrixMultiplication(const FieldMatrixImp& arg1,
  ...
  FieldMatrixType;
  typedef typename FieldMatrixType::row_type
  RowType;
  typedef typename FieldMatrixType::ConstRowIterator
  ConstRowIteratorType;
  typedef typename FieldMatrixType::RowIterator
  RowIteratorType;
  ...
  for (ConstRowIteratorType arg2RowIt = arg2.begin();
       arg2RowIt != arg2RowItEnd, retRowIt != retRowItEnd;
       ++arg2RowIt, ++retRowIt)
  {
    RowType row(0.0);
