...
class FixedMapIterator
    : public boost::iterator_facade< FixedMapIterator<FixedMapType>
...
public:
  ...
  MapWOautoInsert(MapWOautoInsert&& __x)
  noexcept(std::is_nothrow_copy_constructible< _Compare> ::value)
    : BaseType(__x)
  {}

  MapWOautoInsert(std::initializer_list< value_type > __l,
  ...
  MapWOautoInsert(MapWOautoInsert&& __m, const allocator_type& __a)
  noexcept(std::is_nothrow_copy_constructible< _Compare >::value && _Alloc_traits::_S_always_equal())
    : BaseType(__m, __a)
  {}
