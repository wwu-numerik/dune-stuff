...
//reduced from http://stackoverflow.com/questions/1492204/is-it-possible-to-generate-types-with-all-combinations-of-template-arguments
namespace TupleProduct
{
  ...
  static size_t total_recursions = 0;
  ...
  struct Combine
  {
      ...
      struct Next
      {
          ...
          typedef typename if_< boost::is_same<v_next, v_end>,
                                typename if_< boost::is_same<u_next, u_end>,
                                              end_of_recursion_tag,
                                              Generate< u_next, v_begin >
                                            >::type,
                                Generate< UIterator, v_next >
                              >::type  type;
      };
