 ...
 */
void ExtendedParameterTree::add(const Dune::ParameterTree& _other,
...
void ExtendedParameterTree::reportAsSub(std::ostream& stream,
...
void ExtendedParameterTree::reportFlatly(const BaseType& subtree,
                                         const std::string& prefix /*= ""*/,
