...
#if HAVE_LIKWID
# include <likwid.h>
# define DSC_LIKWID_BEGIN_SECTION(name) LIKWID_MARKER_INIT; LIKWID_MARKER_START(name);
# define DSC_LIKWID_END_SECTION(name) LIKWID_MARKER_STOP(name); LIKWID_MARKER_CLOSE;
#else
