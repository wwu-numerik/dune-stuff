 ...
 */
template < class T >
typename std::enable_if< std::is_arithmetic< T >::value, bool >::type float_cmp_eq(const T& xx, const T& yy,
...
struct cmp_type_check
{
  ...
  static constexpr bool is_ok_vector =
      is_vector< FirstType >::value && is_vector< SecondType >::value
