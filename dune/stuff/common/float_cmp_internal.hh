...
struct cmp_type_check
{
  ...
  static constexpr bool is_ok_matrix = std::is_arithmetic<ToleranceType>::value && is_matrix<FirstType>::value
                                       && is_matrix<SecondType>::value
                                       && std::is_same<ToleranceType, typename MatrixAbstraction<FirstType>::R>::value
                                       && std::is_same<ToleranceType, typename MatrixAbstraction<SecondType>::R>::value;
