...
public:
  ...
  static Common::ConfigContainer default_config(const std::string type = available()[0], const std::string sub_name = "")
  {
...
class FunctionsProvider
  : public internal::FunctionsProviderBase< E, D, d, R, r, rC >
{};


template< class E, class D, int d, class R, int r >
class FunctionsProvider< E, D, d, R, r, 1 >
  : public internal::FunctionsProviderBase< E, D, d, R, r, 1 >
{
...
class FunctionsProvider< E, D, 2, R, 1, 1 >
  : public internal::FunctionsProviderBase< E, D, 2, R, 1, 1 >
{
