...
class StructuredGridFactory : public Dune::StructuredGridFactory<GridType>
{
  typedef typename GridType::ctype ctype;
public:
  static std::shared_ptr<GridType> createCubeGrid(const Dune::FieldVector<ctype, GridType::dimension>& lowerLeft,
...
#if HAVE_DUNE_SPGRID
template <class ct, int dim, template <int> class Refinement, class Comm>
class StructuredGridFactory<Dune::SPGrid<ct, dim, Refinement, Comm>> : public Dune::StructuredGridFactory<Dune::SPGrid<ct, dim, Refinement, Comm>>{
  typedef Dune::SPGrid<ct, dim, Refinement, Comm> GridType;
  typedef typename GridType::ctype ctype;

public:
  static std::shared_ptr<GridType> createCubeGrid(const Dune::FieldVector<ctype, dim>& lowerLeft,
...
class StructuredGridFactory<Dune::YaspGrid<dim, Coords>> : public Dune::StructuredGridFactory<Dune::YaspGrid<dim, Coords>> {
