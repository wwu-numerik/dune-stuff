...
struct is_grid_part : public std::is_base_of<Dune::Fem::GridPartInterface<typename G::Traits>, G>
{
};
...
template <class G>
struct is_grid_layer : public integral_constant<bool, is_grid_view<G>::value || is_grid_part<G>::value>
{
};
