...
public:
                                            ...
                                            const std::string sub_name = static_id())
  {
    ...
    return Common::make_unique< ThisType >(id_to_type_map, cfg.get("default_to_dirichlet",
                                                                   default_config().get< bool >("default_to_dirichlet")));
  }
...
template< class IntersectionImp >
class
  DUNE_DEPRECATED_MSG("Use Stuff::Grid::BoundaryInfoInterface instead!")
      GridboundaryInterface
#if HAVE_DUNE_PDELAB
...
template< class IntersectionImp >
class
    DUNE_DEPRECATED_MSG("Use Stuff::Grid::BoundaryInfos::AllDirichlet instead!")
...
template< class IntersectionImp >
class
    DUNE_DEPRECATED_MSG("Use Stuff::Grid::BoundaryInfos::AllNeumann instead!")
...
template< class IntersectionImp >
class
    DUNE_DEPRECATED_MSG("Use Stuff::Grid::BoundaryInfos::IdBased instead!")
      GridboundaryIdBased
  : public GridboundaryInterface< IntersectionImp >
{
  typedef GridboundaryInterface< IntersectionImp >  BaseType;
...
template< class IntersectionImp >
class
    DUNE_DEPRECATED_MSG("Use Stuff::Grid::BoundaryInfos::NormalBased instead!")
      GridboundaryNormalBased
  : public GridboundaryInterface< IntersectionImp >
{
  typedef GridboundaryInterface< IntersectionImp >    BaseType;
public:
