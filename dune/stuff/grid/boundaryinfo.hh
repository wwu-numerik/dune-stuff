...
{
public:
  static const std::string static_id() { return internal::boundary_info_static_id() + ".alldirichlet"; }
...
{
public:
  static const std::string static_id() { return internal::boundary_info_static_id() + ".allneumann"; }
