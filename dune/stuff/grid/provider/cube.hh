...
public:
  ...
  GenericCubeProvider(const Coord lowerLeft, const Coord upperRight,
...
#endif
class CubeProvider
  : public GenericCubeProvider< GridType, ElementVariant<GridType>::id >
{
private:
...
template< typename GridType >
class UnitCubeProvider
  : public CubeProvider< GridType >
{
private:
