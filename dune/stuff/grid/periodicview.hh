...
class PeriodicIntersection
    : public GridViewImp::Intersection
{
...
//    {}
  ...
  LocalGeometry geometryInOutside () const
  {
    if (((BaseType*)this)->neighbor())
      ...
      return ((BaseType*)this)->geometryInOutside(); //find periodic neighbor entity and corresponding intersection and use geometryinInside for that Intersection
  }
  ...
  int indexInOutside () const
  {
    if (((BaseType*)this)->neighbor())
      ...
      return ((BaseType*)this)->indexInOutside(); //find periodic neighbor entity and corresponding intersection and use indexInInside for that Intersection
  }
...
class PeriodicIntersectionIterator
    : public GridViewImp::IntersectionIterator
{
...
public:
  ...
  ibegin ( const typename BaseType::template Codim< 0 >::Entity& entity ) const
  {
  ...
  IntersectionIterator
  iend ( const typename BaseType::template Codim< 0 > :: Entity &entity ) const
  {
