...
public:
  ...
  LocalGeometry geometryInOutside () const
  {
    if (real_intersection_.neighbor())
      ...
      return real_intersection_.geometryInOutside(); //find periodic neighbor entity and corresponding intersection and use geometryinInside for that Intersection
  }
  ...
  int indexInOutside () const
  {
    if (real_intersection_.neighbor())
      ...
      return 0; //find periodic neighbor entity and corresponding intersection and use indexInInside for that Intersection
  }
...
//     : IntersectionIterator < typename GridViewImp::Traits::Grid, PeriodicIntersectionIterator< GridViewImp >, PeriodicIntersection< GridViewImp > >
{
...
public:
  ...
  typedef Dune::IntersectionIterator< Grid, PeriodicIntersectionIterator< GridViewType >, PeriodicIntersection< GridViewType > > IntersectionIterator;
...
public:
  ...
  typename GridViewType::template Codim< cd > :: template Partition< pitype > :: Iterator
  begin () const
  {
  ...
  IntersectionIterator
  ibegin ( const typename GridViewType::template Codim< 0 > :: Entity &entity ) const
  {
  ...
  IntersectionIterator
  iend ( const typename GridViewType::template Codim< 0 > :: Entity &entity ) const
  {
    IntersectionIterator periodic_intersection_iterator = *(new IntersectionIterator(real_grid_view_.ibegin(entity)));
    return periodic_intersection_iterator;
  }
