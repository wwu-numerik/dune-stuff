...
typedef typename Dune::ALUSimplexGrid< 2, 2 >::template Codim< 0 >::Entity DuneStuffFunctionInterfaceAluSimplexGrid2dEntityType;
typedef typename Dune::ALUSimplexGrid< 3, 3 >::template Codim< 0 >::Entity DuneStuffFunctionInterfaceAluSimplexGrid3dEntityType;
