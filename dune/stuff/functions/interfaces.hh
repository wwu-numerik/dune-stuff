  ...
  : public IsLocalizableFunction
{
  typedef LocalizableFunctionInterface
      < EntityImp, DomainFieldImp, domainDim, RangeFieldImp, rangeDimRows, rangeDimCols >
    ThisType;
public:
  typedef EntityImp EntityType;
  ...
  typedef LocalfunctionInterface
      < EntityType, DomainFieldType, dimDomain, RangeFieldType, dimRangeRows, dimRangeCols > LocalfunctionType;
...
public:
  ...
  typedef LocalfunctionInterface
      < EntityType, DomainFieldType, dimDomain, RangeFieldType, dimRange, 1 > LocalfunctionType;
