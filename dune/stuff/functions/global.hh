...
#endif
{
  ...
  typedef LocalfunctionInterface
        < EntityImp, DomainFieldImp, domainDim, RangeFieldImp, rangeDim, 1  > LocalfunctionBaseType;
public:
  ...
  typedef typename Dune::Fem::Function
      ...
      , GlobalFunction< EntityImp, DomainFieldImp, domainDim, RangeFieldImp, rangeDim, 1 > >::JacobianRangeType
    JacobianRangeType;
#else
  typedef typename LocalfunctionBaseType::JacobianRangeType JacobianRangeType;
#endif
