...
//    description["numElements"] = "[100; 20]";
  ...
  static ThisType* create(const Dune::Stuff::Common::ExtendedParameterTree settings)
  {
    ...
    const std::vector< DomainFieldType > lowerLeftIn  = settings.getVector< DomainFieldType >("lowerLeft",
                                                                                                 dimDomain);
    const std::vector< DomainFieldType > upperRightIn = settings.getVector< DomainFieldType >("upperRight",
                                                                                                 dimDomain);
