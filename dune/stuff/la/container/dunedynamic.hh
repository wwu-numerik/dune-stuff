...
template< class ScalarImp = double>
class DuneDynamicVector
  : public VectorInterface< DuneDynamicVectorTraits< ScalarImp > >
...
template< class ScalarImp = double >
class DuneDynamicMatrix
  : public MatrixInterface< DuneDynamicMatrixTraits< ScalarImp > >
...
public:
  ...
  /// This constructor is needed for the python bindings.
  DuneDynamicMatrix(const DUNE_STUFF_SSIZE_T rr,
