...
public:
  ...
  virtual ScalarType l1_norm() const override final { return backend_->template lpNorm<1>(); }

  virtual ScalarType l2_norm() const override final { return backend_->template lpNorm<2>(); }

  virtual ScalarType sup_norm() const override final { return backend_->template lpNorm<::Eigen::Infinity>(); }
