...
public:
  ...
  static Common::ConfigTree options(const std::string& type)
  {
    ...
    Common::ConfigTree iterative_options({"max_iter", "precision", "verbose"},
                                         {"10000",    "1e-10",     "0"});
#if !HAVE_MPI
  ...
  void apply(const IstlDenseVector< S >& rhs, IstlDenseVector< S >& solution, const Common::ConfigTree& opts) const
  {
    ...
    if (type == "bicgstab.amg.ilu0") {
      ...
      Amg::Parameters criterion_parameters(opts.get("preconditioner.max_level", default_opts.get< size_t >("preconditioner.max_level")),
      ...
      criterion_parameters.setDefaultValuesIsotropic(opts.get("preconditioner.isotropy_dim",
                                                              default_opts.get< size_t >("preconditioner.isotropy_dim")));
      criterion_parameters.setDefaultValuesAnisotropic(opts.get("preconditioner.anisotropy_dim",
                                                               default_opts.get< size_t >("preconditioner.anisotropy_dim"))); // <- dim
      criterion_parameters.setDebugLevel(opts.get("preconditioner.verbose",
      ...
      smoother_arguments.relaxationFactor = opts.get("smoother.relaxation_factor",
      ...
      Amg::CoarsenCriterion< Amg::SymmetricCriterion< IstlMatrixType, Amg::FirstDiagonal > >
          smoother_criterion(criterion_parameters);
      ...
      typedef Dune::Amg::AMG< MatrixOperatorType,
                              typename IstlDenseVector< S >::BackendType,
                              SmootherType > PreconditionerType;
      ...
      Dune::Amg::Parameters params(opts.get("preconditioner.max_level", default_opts.get< size_t >("preconditioner.max_level")),
                                   opts.get("preconditioner.coarse_target",
                                            default_opts.get< size_t >("preconditioner.coarse_target")),
                                   opts.get("preconditioner.min_coarse_rate",
                                            default_opts.get< S >("preconditioner.min_coarse_rate")),
                                   opts.get("preconditioner.prolong_damp", default_opts.get< S >("preconditioner.prolong_damp")));
      params.setDefaultValuesIsotropic(opts.get("preconditioner.isotropy_dim",
                                                              default_opts.get< size_t >("preconditioner.isotropy_dim")));
      ...
      amg_criterion.setDebugLevel(opts.get("preconditioner.verbose", default_opts.get< size_t >("preconditioner.verbose")));
