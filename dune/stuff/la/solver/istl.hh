...
public:
  ...
  void apply(const IstlDenseVector< S >& rhs, IstlDenseVector< S >& solution, const Common::ConfigTree& opts) const
  {
    ...
    if (type == "bicgstab.amg.ilu0") {
      ...
      Amg::Parameters smoother_parameters(opts.get("smoother.max_level", default_opts.get< size_t >("smoother.max_level")),
      ...
      smoother_parameters.setDefaultValuesAnisotropic(opts.get("smoother.anisotropy_dim",
      ...
      Amg::CoarsenCriterion< Amg::SymmetricCriterion< IstlMatrixType, Amg::FirstDiagonal > >
          smoother_criterion(smoother_parameters);
