...
//template< class MatrixImp, class VectorImp >
//class CgDiagonalSolver< MatrixImp, VectorImp, typename std::enable_if< IsIstlMV< MatrixImp, VectorImp >::value >::type >
//  : public SolverInterface< MatrixImp, VectorImp >
//{
//  typedef SolverInterface< MatrixImp, VectorImp > BaseType;
//public:
...
template< class MatrixImp, class VectorImp >
class BicgstabILUTSolver< MatrixImp, VectorImp,
                          typename std::enable_if< IsIstlMV< MatrixImp, VectorImp >::value >::type >
  : public SolverInterface< MatrixImp, VectorImp >
{
  typedef SolverInterface< MatrixImp, VectorImp > BaseType;
public:
                       ...
                       const Dune::ParameterTree description = BaseType::defaultIterativeSettings()) const
  {
    ...
    PreconditionerType preconditioner(*(lhs.backend_),
                                      description.get("preconditioner.iterations", defaultSettings().template get< size_t >("preconditioner.iterations")),
                                      description.get("preconditioner.relaxation_factor", defaultSettings().template get< double >("preconditioner.relaxation_factor")));
...
template< class MatrixImp, class VectorImp >
class AmgSolver< MatrixImp, VectorImp,
                          typename std::enable_if< IsIstlMV< MatrixImp, VectorImp >::value >::type >
  : public SolverInterface< MatrixImp, VectorImp >
{
  typedef SolverInterface< MatrixImp, VectorImp > BaseType;
