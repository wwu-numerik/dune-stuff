...
public:
                       ...
                       const Dune::ParameterTree description = defaultSettings()) const
  {
    ...
    solver.preconditioner().setDroptol(description.get("preconditioner.dropTol", defaults.get< double >("preconditioner.dropTol")));
    solver.preconditioner().setFillfactor(description.get("preconditioner.fillFactor", defaults.get< double >("preconditioner.fillFactor")));
