...
public:
                       ...
                       const Dune::ParameterTree description = defaultSettings()) const
  {
    ...
    solver.preconditioner().setDroptol(description.get("preconditioner.dropTol", defaults.template get< double >("preconditioner.dropTol")));
    solver.preconditioner().setFillfactor(description.get("preconditioner.fillFactor", defaults.template get< double >("preconditioner.fillFactor")));
