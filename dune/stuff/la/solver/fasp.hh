...
private:
  input_param initInputParams(const size_type& maxIter, const ElementType& precision, const Dune::ParameterTree& description) const
  {
...
//    inputParam.workdir = description.get< char >("input_param.workdir", '.');
  ...
  itsolver_param initItsolverParams(const size_type& maxIter, const ElementType& precision, const Dune::ParameterTree& description) const
  {
  ...
  AMG_param initAMGParams(const size_type& maxIter, const ElementType& precision, const Dune::ParameterTree& description) const
  {
    AMG_param amgParams;
  ...
  ILU_param initIluParams(const size_type& /*maxIter*/, const ElementType& /*precision*/, const Dune::ParameterTree& description) const
  {
    ILU_param iluParams;
  ...
  Schwarz_param initSchwarzParams(const size_type& /*maxIter*/, const ElementType& /*precision*/, const Dune::ParameterTree& description) const
  {
