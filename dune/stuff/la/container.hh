...
typename Space::RangeFieldType communicated_dot(const Dune::Stuff::LA::IstlDenseVector<typename Space::RangeFieldType>&
                                                vector,
...
template < template <class> class VectorImp, class Space >
void ensure_parallel_dof_consistency(VectorImp<typename Space::RangeFieldType>& /*vector*/,
                                     const Space& /*space*/)
{
