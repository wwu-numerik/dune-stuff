...
struct GTraits
{
  ...
  typedef Dune::Fem::LagrangeDiscreteFunctionSpace<ContFunctionSpace,
                                                   Dune::Fem::AdaptiveLeafGridPart<Grid>,
                                                   polynomial_order>
      DiscreteSpace;
...
#if HAVE_DUNE_PDELAB
  typedef PDELab::
      QkLocalFiniteElementMap<typename Grid::LeafGridView, typename Grid::ctype, FieldType, polynomial_order>
          FEMap;
  typedef Dune::PDELab::ISTLVectorBackend<> VectorBackend;
  typedef Dune::PDELab::istl::BCRSMatrixBackend<> MatrixBackend;
  typedef PDELab::
      GridFunctionSpace<typename Grid::LeafGridView, FEMap, PDELab::ConformingDirichletConstraints, VectorBackend>
          GridFunctionSpace;
