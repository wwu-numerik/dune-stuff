...
public:
  ...
  static Dune::ParameterTree createSampleDescription(const std::string /*subName*/ = "")
  {
    DUNE_THROW(Dune::NotImplemented,
               ...
               << " FunctionSpe10Model1 not implemented for this combination of dimDomain = " << domainDim
               << " and rangeDim = " << rangeDim << "!");
  }

  static FunctionSpe10Model1< DomainFieldImp, domainDim, RangeFieldImp, rangeDim >* create(const Dune::Stuff::Common::ExtendedParameterTree /*description*/)
  {
    DUNE_THROW(Dune::NotImplemented,
               "\n" << Dune::Stuff::Common::colorStringRed("ERROR:")
               << " FunctionSpe10Model1 not implemented for this combination of dimDomain = " << domainDim
