...
public:
  ...
  void evaluate(const Dune::FieldVector< DomainFieldType, domainSize >& arg, Dune::FieldVector< RangeFieldType, rangeSize >& ret) const
  {
...
template< class DomainFieldImp, int maxDimDomain, class RangeFieldImp, int maxDimRange >
const std::string Expression< DomainFieldImp, maxDimDomain, RangeFieldImp, maxDimRange >::id = "helper-tools.function.expression";
