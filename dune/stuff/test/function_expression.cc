...
int main(int argc, char** argv)
{
  try {
    ...
    std::cout << "scalar_f_from_single_expression(" << scalar_x << ") = "
              << scalar_value << " (should be 3)" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "scalar_f_from_paramtree_with_single_expression(" << scalar_x << ") = "
              << scalar_value << " (should be 3)"<< std::endl;
    std::cout << std::endl;
    ...
    std::cout << "scalar_f_from_paramtree_with_expressions(" << scalar_x << ") = "
              << scalar_value << " (should be 3)"<< std::endl;
    std::cout << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "vector_f_from_paramtree_with_expressions(" << vector_x << ") = "
              << vector_value << " (should be 3 -3)"<< std::endl;
    std::cout << std::endl;
    ...
    std::cout << "coefficientFunction(" << mu << ") = "
              << coefficient_value << " (should be 2)" << std::endl;
    std::cout << std::endl;
