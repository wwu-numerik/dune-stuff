...
int main(int argc, char** argv)
{
  try {
    ...
    std::cout << "scalar_f_from_single_expression(" << scalar_x << ") = " << scalar_value << " (should be 3)" << std::endl;
    std::cout << std::endl;
    ...
    ScalarFunctionType scalar_f_from_paramtree_with_single_expression = ScalarFunctionType::createFromParamTree(scalar_paramTree_single_expression);
    ...
    std::cout << "scalar_f_from_paramtree_with_single_expression(" << scalar_x << ") = " << scalar_value << " (should be 3)"<< std::endl;
    std::cout << std::endl;
    ...
    ScalarFunctionType scalar_f_from_paramtree_with_expressions = ScalarFunctionType::createFromParamTree(scalar_paramTree_expressions);
    ...
    std::cout << "scalar_f_from_paramtree_with_expressions(" << scalar_x << ") = " << scalar_value << " (should be 3)"<< std::endl;
    std::cout << std::endl;
    std::cout << std::endl;
    ...
    VectorFunctionType vector_f_from_paramtree_with_expressions = VectorFunctionType::createFromParamTree(vector_paramTree_expressions);
    ...
    std::cout << "vector_f_from_paramtree_with_expressions(" << vector_x << ") = " << vector_value << " (should be 3 -3)"<< std::endl;
...
//    std::cout << "scalar_paramFunction(" << tooLargeParam << ") = " << paramValue << " (should fail)"<< std::endl;
    ...
    std::cout << "multiple_paramFunction(" << scalarParam << ") = " << paramValue << " (should be 1, mu[1] .. mu[4] are treated as 0)"<< std::endl;
