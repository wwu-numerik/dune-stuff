...
int main() {
  ...
  std::cout << underline << "a colored 'hello world': " << endunderline
            << bgreen << "hello world" << normal << std::endl;
  std::cout << underline << "a blinking 'hello world': " << endunderline
            << blink << "hello world" << endblink << std::endl;
  std::cout << underline << "an italic 'hello world': " << endunderline
            << italic << "hello world" << enditalic << std::endl;
  std::cout << underline << "an underlined 'hello world': " << endunderline
            << underline << "hello world" << endunderline << std::endl;
  std::cout << underline << "a reverse 'hello world': " << endunderline
            << reverse << "hello world" << endreverse << std::endl;
