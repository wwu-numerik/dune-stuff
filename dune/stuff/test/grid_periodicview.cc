      ...
      for (PeriodicIntersectionIteratorType i_it = periodic_grid_view.ibegin(entity); i_it != i_it_end; ++i_it) {
        ...
        if (intersection.neighbor())
          ...
          if (intersection.is_periodic()) {
              ...
              EXPECT_TRUE((Dune::Stuff::Common::FloatCmp::eq(global_outside_coords[differing_coordinate], 1) && Dune::Stuff::Common::FloatCmp::eq(global_intersection_coords[differing_coordinate], 0))
                       || (Dune::Stuff::Common::FloatCmp::eq(global_outside_coords[differing_coordinate], 0) && Dune::Stuff::Common::FloatCmp::eq(global_intersection_coords[differing_coordinate], 1)));
          }
