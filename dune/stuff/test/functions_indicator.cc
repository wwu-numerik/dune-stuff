...
TYPED_TEST(IndicatorFunctionYaspGridEntityTest, provides_required_methods) { this->check(); }
...
TYPED_TEST(IndicatorFunctionAluGridEntityTest, provides_required_methods) { this->check(); }
