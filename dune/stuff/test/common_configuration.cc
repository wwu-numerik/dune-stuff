...
struct ConfigTest : public testing::Test {
  ...
  //std::array is not assignable from list_of it seems. Don't make the following two boost::arrays const (triggers intel compiler bug, at least with icpc version 14.0.3).
