...
TYPED_TEST(GlobalLambdaFunctionTestYaspGridEntityTest, provides_required_methods) { this->check(); }
...
TYPED_TEST(GlobalLambdaFunctionTestAluGridEntityTest, provides_required_methods) { this->check(); }
