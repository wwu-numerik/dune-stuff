...
TYPED_TEST(CubeGridProvider, is_default_creatable) { this->is_default_creatable(); }
TYPED_TEST(CubeGridProvider, fulfills_const_interface) { this->const_interface(); }
TYPED_TEST(CubeGridProvider, is_visualizable) { this->visualize(); }

#if HAVE_DUNE_FEM

TYPED_TEST(CubeGridProvider, fulfills_non_const_interface) { this->non_const_interface(); }
