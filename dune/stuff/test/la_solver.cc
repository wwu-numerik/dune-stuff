...
LA::Container::EigenDenseMatrix< ElementType >* createIdentityMatrix(const LA::Container::EigenDenseMatrix< ElementType >& /*emptyDummy*/)
{
...
template< class ElementType >
LA::Container::EigenRowMajorSparseMatrix< ElementType >* createIdentityMatrix(const LA::Container::EigenRowMajorSparseMatrix< ElementType >& /*emptyDummy*/)
{
...
#if HAVE_EIGEN
template< class ElementType >
LA::Container::EigenDenseVector< ElementType >* createVector(const LA::Container::EigenDenseVector< ElementType >& /*emptyDummy*/)
{
...
struct SolverBaseTest
{
  ...
  static void run()
  {
    ...
    for (std::string solverType : LA::Solver::types()) {
      const LA::Solver::Interface< MatrixType, VectorType >* solver = LA::Solver::create< MatrixType, VectorType >(solverType);
      solver->apply(*A, *f, x);
      delete solver;
    }
    delete A;
...
struct SolverTest
  : public ::testing::Test
{
  typedef boost::mpl::vector< LA::Container::EigenDenseMatrix< double >,
                              LA::Container::EigenRowMajorSparseMatrix< double > >  MatrixTypes;
  typedef boost::mpl::vector< LA::Container::EigenDenseVector< double > >           VectorTypes;
  typedef typename DSC::TupleProduct::Combine<  MatrixTypes,
                                                VectorTypes,
