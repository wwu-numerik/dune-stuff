...
TYPED_TEST(ExpressionFunctionYaspGridEntityTest, provides_required_methods) { this->check(); }
...
TYPED_TEST(ExpressionFunctionAluGridEntityTest, provides_required_methods) { this->check(); }
