...
#define YASPGRIDS                                                                                                      \
  Dune::YaspGrid<1, Dune::EquidistantOffsetCoordinates<double, 1>>, Dune::YaspGrid<2, Dune::EquidistantOffsetCoordinates<double, 2>>,          \
      Dune::YaspGrid<3, Dune::EquidistantOffsetCoordinates<double, 3>>, Dune::YaspGrid<4, Dune::EquidistantOffsetCoordinates<double, 4>>
