...
TYPED_TEST(ConstantFunctionYaspGridEntityTest, provides_required_methods) { this->check(); }
...
TYPED_TEST(ConstantFunctionAluGridEntityTest, provides_required_methods) { this->check(); }
