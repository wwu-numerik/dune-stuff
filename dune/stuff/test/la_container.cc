  ...
  : public ::testing::Test
{
  ...
  void produces_correct_results() const
  {
    ...
    EXPECT_TRUE(result_mv_1[0] == ScalarType(1.25) && result_mv_1[1] == ScalarType(1.25)
        && result_mv_1[2] == ScalarType(1.75) && result_mv_1[3] == ScalarType(0)) << result_mv_1;
    ...
    EXPECT_TRUE(result_mv_1[0] == ScalarType(5) && result_mv_1[1] == ScalarType(6)
        && result_mv_1[2] == ScalarType(7) && result_mv_1[3] == ScalarType(8)) << result_mv_1;
    testmatrix_sparse.mv(vector_ones, result_mv_1);
    EXPECT_TRUE(result_mv_1[0] == ScalarType(0.5) && result_mv_1[1] == ScalarType(2.5)
        && result_mv_1[2] == ScalarType(-0.5) && result_mv_1[3] == ScalarType(0)) << result_mv_1;
