...
template< DSCFl::Style style, class FirstType, class SecondType >\
      typename std::enable_if< DSCFl::internal::cmp_type_check<FirstType, SecondType, typename DSCFl::MT<FirstType>::T>::value, void >::type\
...
template< class FirstType, class SecondType > \
    typename std::enable_if< DSCFl::internal::cmp_type_check<FirstType, SecondType, \
typename DSCFl::MT<FirstType>::T>::value, void >::type \
DSC_EXPECT_FLOAT_##ID (const FirstType& first, \
